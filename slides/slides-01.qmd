...
- Course Jupyter book: [https://ubc-cs.github.io/cpsc330-2024W2/README.html](https://ubc-cs.github.io/cpsc330-2024W2/README.html)
- Course GitHub repository: [https://github.com/UBC-CS/cpsc330-2024W2](https://github.com/UBC-CS/cpsc330-2024W2)
...
::: {.column width="20%"}
<img src="img/andy.jpg" height="150">
:::
...
- Please fill out [Getting to know you survey](https://canvas.ubc.ca/courses/153207/quizzes) when you get a chance.

## Asking questions during class
You are welcome to ask questions by raising your hand.
There is also [a reflection Google Document](https://docs.google.com/document/d/1TDxvJupYOLcJF9Mljqko-k3Jzo_lXQYQyzrvyApr2TE/edit?usp=sharing) for this course for your questions/comments/reflections. It will be great if you can write about your takeaways, struggle points, and general comments in this document so that I'll try to address those points in the next lecture. 


## Activity 1: https://shorturl.at/D8v0w
\

- Write your answers to the questions below in this Google doc: [https://shorturl.at/D8v0w](https://shorturl.at/D8v0w)
...
## Predicting labels of a given image {.smaller}
...
## Predicting housing prices {.smaller}
...
::: {.callout-important}
Course website: [https://github.com/UBC-CS/cpsc330-2024W2](https://github.com/UBC-CS/cpsc330-2024W2) is the most important link. Please read everything on this GitHub page!
:::
...
Read [https://github.com/UBC-CS/cpsc330-2024W2/blob/main/docs/330_vs_340.md](https://github.com/UBC-CS/cpsc330-2024W2/blob/main/docs/330_vs_340.md)
...
::: {.callout-important}
Please go through [this document](https://github.com/UBC-CS/cpsc330-2024W2/blob/master/docs/course_info.md#registration) carefully before contacting your instructors about these issues. Even then, we are very unlikely to be able to help with registration, waitlist or prerequisite issues.
:::

- If you are on waitlist and if you'd like to try your chances, you should be able to access [Canvas](https://canvas.ubc.ca/courses/153207) and [Piazza](https://piazza.com/class/m4ujp0s4xgm5o5).  
- If you're unable to make it this time, this course will be offered in the summer.

## Lecture format {.smaller}
...
- Our main forum for getting help will be [Piazza](https://piazza.com/class/m4ujp0s4xgm5o5).

::: {.callout-important}
Please read [this entire document about asking for help](https://github.com/UBC-CS/cpsc330-2024W2/blob/main/docs/asking_for_help.md).
**TLDR:** Be nice.
:::
...
- All the lectures are [available here](https://ubc-cs.github.io/cpsc330-2024W2/README.html).
- While the lecture notes are largely fixed, there may be small changes over the course of the term.
- A "finalized" version will be pushed to [GitHub](https://github.com/UBC-CS/cpsc330-2024W2) and the [Jupyter book](https://ubc-cs.github.io/cpsc330-2024W2/README.html) right before each class.
...
[https://github.com/UBC-CS/cpsc330-2024W2/tree/main/lectures](https://github.com/UBC-CS/cpsc330-2024W2/tree/main/lectures).

## Grades

- The grading breakdown is [here](https://github.com/UBC-CS/cpsc330-2024W2/blob/main/syllabus.md#grading-scheme). 
- The policy on challenging grades is [here](https://github.com/UBC-CS/cpsc330-2024W2/blob/main/docs/grades.md).
...
- Follow the setup instructions [here](https://ubc-cs.github.io/cpsc330-2024W2/docs/setup.html) to create a course `conda` environment on your computer. 
...
but you can find some useful Python resources [here](https://github.com/UBC-CS/cpsc330-2024W2/blob/main/docs/resources.md).  
:::
...
- [ ] Are you able to access course [Canvas](https://canvas.ubc.ca/courses/153207) shell? 
- [ ] Are you able to access [course Piazza](https://piazza.com/class/m4ujp0s4xgm5o5)?
- [ ] Are you able to access Gradescope? (If not, refer to the [Gradescope Student Guide](https://lthub.ubc.ca/guides/gradescope-student-guide/).)
    - **Please join Gradescope through the Canvas.**
- [ ] Are you able to access [iClicker Cloud](https://join.iclicker.com/HTRZ) for this course?
- [ ] Did you follow the setup instructions [here](https://ubc-cs.github.io/cpsc330-2024W2/docs/setup.html) to create a course conda environment on your computer?
- [ ] Did you complete the [syllabus quiz](https://us.prairielearn.com/pl/course_instance/172119/assessment/2494388) on Prairilearn?  (Due date: Friday, January 24th at 11:59pm)
